        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          ...
          <li class="items-center">
            ...
            >
              ...
              >
                <i
                  class="fas fa-address-card mr-2 text-sm"
                  :class="[isActive ? 'opacity-75' : 'text-gray-400']"
                ></i>
                Profile
              </a>
...
<script>
import FacilityNotificationDropdown from "@/components/Facility/FacilityDropdowns/FacilityNotificationDropdown.vue";
import FacilityUserDropdown from "@/components/Facility/FacilityDropdowns/FacilityUserDropdown.vue";
import FacilityWalletDropdown from "@/components/Facility/FacilityDropdowns/FacilityWalletDropdown.vue";
...
export default {
  ...
  components: {
    FacilityNotificationDropdown,
    FacilityUserDropdown,
    FacilityWalletDropdown,
  },
};
</script>
